        ...
        return (
          <Portal>
            <Dialog visible={this.state.visible}
                ...
                <Dialog.Title>Just to be sure</Dialog.Title>
                <Dialog.Content>
                    <Paragraph>Do you really want to delete your profile image?</Paragraph>
                </Dialog.Content>
                <Dialog.Actions>
